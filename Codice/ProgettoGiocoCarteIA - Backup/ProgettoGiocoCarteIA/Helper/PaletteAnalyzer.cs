...
namespace ObjectRecognition
{
    public class PaletteAnalyzer
    {
        ...
        public static Dictionary<Color, ColorInformation> AnalyzeBitmaps(BitmapImage imageWithObject, BitmapImage imageWithoutObject)
        {
        ...
        public static Dictionary<Color, ColorInformation> GetColorPallete(BitmapImage bmpImage)
        {
        ...
        protected static Bitmap BitmapImage2Bitmap(BitmapImage bitmapImage)
        {
